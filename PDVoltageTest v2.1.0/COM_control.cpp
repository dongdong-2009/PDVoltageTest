...
int cmd_get_system_consumptoin(char *s)
{
	...
	{   /*
		...
		*/
		...
		TEdit* edtSetCurrent = (TEdit *)FrmMain->FindComponent("edtSetCurrent"+g_PD_Vol);
		if(dCurrent<(edtSetCurrent->Text.ToDouble()-0.2)||dCurrent>(edtSetCurrent->Text.ToDouble()+0.2))
		{
