...
const AnsiString APP_TITLE = "PD Voltage Test Tool  ver 2.1.0 ( Action Star.2018)";
//
...
__published:	// IDE-managed Components
	...
	TEdit *edtSetCurrent9;
	TEdit *edtSetCurrent12;
	TEdit *edtSetCurrent15;
	TEdit *edtSetCurrent20;
	TPanel *Panel22;
	TPanel *Panel71;
	TPanel *pl_Auto;
	TPanel *plLossVol;
